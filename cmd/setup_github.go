...
var setupGithubCmd = &cobra.Command{
	...
	Long:  `The setup-github command configures GitHub Actions to integrate with the Go AI Agent for tasks like issue triage and PR reviews.`, //nolint:staticcheck
