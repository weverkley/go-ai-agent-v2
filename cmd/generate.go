...
// runGenerateCmd handles the generate command logic.
func runGenerateCmd(cmd *cobra.Command, args []string, settingsService types.SettingsServiceIface, shellService services.ShellExecutionService) {
