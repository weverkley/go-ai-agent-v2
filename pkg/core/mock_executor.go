	...
	mock.GenerateStreamFunc = func(ctx context.Context, contents ...*genai.Content) (<-chan any, error) {
		...
		go func() {
			...
			steps := []types.ToolCallStartEvent{
				...
				{ToolCallID: "mock-30", ToolName: "checkout_branch", Args: map[string]interface{}{"dir": cwd, "branch_name": "feature/auth"}},
				{ToolCallID: "mock-31", ToolName: "get_current_branch", Args: map[string]interface{}{"dir": cwd}},
				{ToolCallID: "mock-32", ToolName: "get_remote_url", Args: map[string]interface{}{"dir": cwd}},
				{ToolCallID: "mock-33", ToolName: "pull", Args: map[string]interface{}{"dir": cwd}},
