...
type Executor interface {
	...
	CompressChat(history []*types.Content, promptId string) (*types.ChatCompressionResult, error)
	StreamContent(ctx context.Context, contents []*types.Content, tools []types.Tool) (<-chan any, error)
